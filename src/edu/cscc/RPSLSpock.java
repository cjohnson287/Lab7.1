...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick this allows the user to pick an option for the game
     * @return this allows it to return and be used
     */
     ...
     * @author Charles Johnson
     *
     * @return returns the case back so it can generate a pick
     */
